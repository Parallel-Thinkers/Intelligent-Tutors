...
<!-- 	<h2 id = "heading">Intelligent Tutor for Math Word Problems</h2>	 -->
	<h2 id = "heading">Teacher Profile</h2>
...
<!--
 ...
 -->
 		    ...
 		    <button type="button" id="sp" data-toggle="modal" data-target="#studentprofile">STUDENT PROFILE</button>
...
<!-- 			<button onclick="window.open('Help/System Interaction Help.html','Help','width=650,height=500,top=150,left=650')">Help</button>
 -->			</td>			
			 ...
			 <td>
			 <td>
		<s:form action="teacherhome.action" method="post">
		...
		<div id = "Content">
<h3 align="center"><s:property value="problemtypeid"/></h3>
		<!--    <div id = "ProblemFrame">
			 ...
			 --> 
			  <div id ="message1">
		        <ul>
		            <li><a href="progress.action">Problem Solving Progress</a></li>
		         	<li><a href="missconcept.action">Missingconcepts</a></li>
    		       <li><a href="missconception.action">Misconceptions</a></li>
			       <li><a href="covering.action?probtypeid=<s:property value="problemtypeid"/>&uname=<s:property value="usrnm"/>">Learned Concepts</a></li>
			        <li><a href="mensuration.action">Learning Profile of Mensuration Domain</a></li>
			          <li><a href="activity.action">Activity</a></li>
		...
		<s:form action="selectAnswer" method="post" >	    
				...
				<table class="CSSTableGenerator" style="display: block;height: 600px	;overflow-y: scroll;width: 100%">
                   ...
                   <tr style="overflow:auto">
                    <td colspan="9" align="center">Problem Solving Progress </td>
                   </tr>
                   <tr>
                   <td width="20%" rowspan="2"><h3	 align="center">Problem Type</h3></td>
                   <td width="10%" colspan="2"><h3 align="center">Easy</h3></td>
                   <td width="10%" colspan="2"><h3 align="center">Medium</h3></td>
                   <td width="10%" colspan="2"><h3 align="center">Hard</h3></td>
                   <td width="20%" rowspan="2"><h3 align="center">Overall</h3></td>
                   </tr>
                   <tr>
                                         
                     <td width="10%"><b>Attempts</b></td>
                     <td width="10%"><b>Correct</b></td>
                     <td width="10%"><b>Attempts</b></td>
                     <td width="10%"><b>Correct</b></td>
                     <td width="10%"><b>Attempts</b></td>
                     <td width="10%"><b>Correct</b></td>                     
                    ...
                    <s:iterator value="progress"> 
                     <tr style="overflow:auto">
                     <td width="20%"><s:property value="problemtype"/></td>
                     <td width="10%"><s:property value="easy_attemps"/></td>
                     <td width="10%"><s:property value="easy_correct"/> %</td>
                     <td width="10%"><s:property value="medium_attemps"/></td>
                     <td width="10%"><s:property value="medium_correct"/> %</td>
                     <td width="10%"><s:property value="hard_attemps"/></td>
                     <td width="10%"><s:property value="hard_correct"/> %</td>
                     <td width="20%"><s:property value="overall"/> %</td>
