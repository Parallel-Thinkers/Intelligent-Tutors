...
<!-- 			<button onclick="window.open('Help/System Interaction Help.html','Help','width=650,height=500,top=150,left=650')">Help</button>
 -->			</td>			
		...
		<s:form action="selectAnswer" method="post" >	    
                  ...
                  <table class="CSSTableGenerator" style="display: block;height:110px	;overflow-y: scroll;width: 100%">
                   
                   <tr>
                    <td colspan="2" align="center">Learned Concepts </td>
                   </tr>
                   <tr>
                     <td width="70%"><center><b> Concept Name</b></center></td>
                     <td width="30%"><center><b>Count</b></center></td>
                    ...
                    <s:iterator value="resultMap"> 
                     <tr>
                     <td width="70%"><s:property value="key"/></td>
                 ...
                 <img src="images/graph.jpeg" height="490" width="720"/>
